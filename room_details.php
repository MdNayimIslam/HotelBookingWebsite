        ...
        <div class="row">
            <div class="col-12 my-5 mb-4 px-4">
                ...
                <div style="font-size:14px">
                    ...
                    <span> > </span>
                    <a href="room.php" class=" text-decoration-none">ROOMS</a>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        echo <<<guests
                                    <div class="guest mb-3">
                                        ...
                                        <span class="badge rounded-pill bg-light text-dark text-warp me-1 mb-1">$room_data[adult] Adults</span> 
                                        <span class="badge rounded-pill bg-light text-dark text-warp me-1 mb-1">$room_data[children] Children</span>
                                    </div>
                                guests;
                        echo <<<area
                                    <div class=" mb-3 ">
                                        <h6 class="mb-1">Area</h6>
                                        <span class='badge rounded-pill bg-light text-dark text-warp me-1 mb-1'>$room_data[area] sq.ft.</span>
                                    </div>
                                area;
                        $book_btn = "";
                            ...
                            while($row = mysqli_fetch_assoc($review_res)){
                                ...
                                echo<<<reviews
                                            ...
                                            <div class="d-flex align-item-center mb-2">
                                                ...
                                                <h6 class="m-0 ms-3">$row[uname]</h6>
                                            </div>
                                            <p>$row[review]</p>
                                            <div>
                                            $stars
