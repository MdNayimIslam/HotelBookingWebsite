...
function get_all_rooms() {
    ...
    xhr.open("POST", "ajax/rooms.php", true);
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded'); //Request Header
    xhr.onload = function () {
...
function submit_edit_room() {
    ...
    xhr.onload = function () {
        ...
        modal.hide();
        if (this.responseText == 1) {
            alert('success', 'Edited room data');
...
function add_image() {
    ...
    xhr.onload = function () {
        if (this.responseText == 'inv_img') {
            ...
            room_images(add_image_form.elements['room_id'].value,
                document.querySelector("#room-images .modal-title").innerText);
            add_image_form.reset();
        }
    }
    xhr.send(data); //data send to POST
}
